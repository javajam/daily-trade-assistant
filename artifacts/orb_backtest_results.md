...
BEFORE vs AFTER on this same Yahoo window: `artifacts/orb_ema_midpoint_comparison.md`.
...
- Wins / losses / scratch: 1 / 3 / 1
- Win rate: 20.00%
- Total P&L: $-35.58 (-0.036% of starting equity)
- Avg win: $5.72
- Avg loss: $-13.77
- Max drawdown: $41.30 (0.04%)
- Ending equity: $99,964.42
...
- Stop is the opening-range extreme (long → OR low, short → OR high); take-profit is the OR midpoint (take_profit_mode: or_midpoint, default). Set orb.stop_mode: reversal_candle to restore the previous candle-extreme stop. Set orb.take_profit_mode: one_r for a 1R target. Set orb.take_profit_mode: first_profitable_close to restore the first-profit close exit.
